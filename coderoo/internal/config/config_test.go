...
func TestLoadFile_MissingFile(t *testing.T) {
	cfg, err := LoadFile("/nonexistent/path/site.yaml")
	if err != nil {
...
func TestResolve_DefaultsOnly(t *testing.T) {
	cfg, err := Resolve(ResolveOptions{
		ConfigPath: "/nonexistent/site.yaml",
	})
	if err != nil {
...
func TestResolve_EnvVarsWin(t *testing.T) {
	...
	t.Setenv("CODEROO_SITE_TITLE", "Env Title")
...
func TestEnv_StringField(t *testing.T) {
	cfg := Defaults()
	t.Setenv("CODEROO_SITE_TITLE", "From Env")

	applyEnvOverrides(cfg, "CODEROO")
...
func TestEnv_BoolField(t *testing.T) {
	cfg := Defaults()
	t.Setenv("CODEROO_BUILD_DRAFTS", "true")
...
func TestEnv_IntField(t *testing.T) {
	cfg := Defaults()
	t.Setenv("CODEROO_SERVER_PORT", "8080")
