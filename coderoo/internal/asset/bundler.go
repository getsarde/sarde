...
func (b *Bundler) resolverPlugin() api.Plugin {
	return api.Plugin{
		...
		Setup: func(build api.PluginBuild) {
			...
			build.OnLoad(api.OnLoadOptions{Filter: ".*", Namespace: "coderoo-embedded"}, func(args api.OnLoadArgs) (api.OnLoadResult, error) {
